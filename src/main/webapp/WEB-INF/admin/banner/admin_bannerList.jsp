	           						...
	           						aria-describedby = "dataTable_info">
	           							...
	           							<tfoot>
			           						<tr>
					            				...
					            				<th rowspan = "1">Contents</th>
					            				<th rowspan = "1">SubContents</th>
			           					...
			           					<tbody>
			           						<c:forEach var="banner" items="${bannerList }">
					            				<tr>
						            				...
						            				<td onclick="location.href='admin_banner.mdo?banner_serial=${banner.banner_serial}'">${banner.banner_subcontents }</td>
						            				<td onclick="location.href='admin_banner.mdo?banner_serial=${banner.banner_serial}'"><img src="${banner.banner_filepath }"></td>
					            				</tr>
					            			</c:forEach>
	           							</tbody>
	           						</table>
