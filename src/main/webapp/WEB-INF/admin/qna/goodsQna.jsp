            ...
            <!-- 여기서부터 작성하세요 -->
	           	...
	           	<div class = "card shadow mb-4">
	           		<div class = "card-header py-3">
	           			<h3 class = "m-0 font-weight-bold text-primay" style = "margin-top : 20px;">Inquiries about products (waiting for an answer)</h3>
	           		</div>
	           		<div class = "card-body">
	           						...
	           						aria-describedby = "dataTable_info">
	           							...
	           							<tfoot>
			           						<tr>
					            				...
					            				<th rowspan = "1" style = "width : 15%">Delete Inquiry</th>
			           						</tr>
			           					</tfoot>
			           					<tbody>
			           						<c:forEach var="List" items="${gqnaList}">
												<tr>
													...
													<td><input type="button" value="답변하기" class="btn btn-success" onclick="location.href='toAnswer.mdo?qna_goods_serial=${List.qna_goods_serial}'"/></td>
													<td>
														<input type="button" value="삭제"  class="btn btn-success" onclick="javascript:delete_check('deleteGqna.mdo?qna_goods_serial=${List.qna_goods_serial}')"/>
													</td>
												</tr>
											</c:forEach>
	           							</tbody>
