	           		...
	           		<div class = "card-body">
	           			<div class = "table-responsive">
	           				<div class = "row">
	           					<div class = "col-sm-12">
	           						<!-- form -->
	           						<form action = "updateGqna.mdo?qna_goods_serial=${qnaone.qna_goods_serial }" method = "POST">
	           							...
	           							<table class = "table table-bordered dataTable" cellspacing = "0">
											...
											<tr>
												...
												<td>
													<textarea class = "form-control" name="qna_goods_answer"></textarea>
												</td>
											</tr>
	           							</table>
										...
										<button type = "submit" class="btn btn-success" style = "margin-left:10px; float : right;">등록하기</button>
	           							<button type = "button" class="btn btn-success" style = "margin-left:10px; float : right;" onclick ="location.href='gqnaList.mdo'">목록보기</button>
	           							<!--// button -->
	           						</form>
	           						<!--// form -->
	           					</div>
