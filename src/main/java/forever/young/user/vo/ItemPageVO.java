...
public class ItemPageVO {
	...
	public String toString() {
		return "ItemPageVO [category_first_serial=" + category_first_serial + ", category_second_serial="
				+ category_second_serial + ", category_third_serial=" + category_third_serial
				+ ", category_goods_serial=" + category_goods_serial + ", category_goods_name=" + category_goods_name
				+ ", category_goods_delivery=" + category_goods_delivery + ", category_goods_brand="
				+ category_goods_brand + ", category_goods_point=" + category_goods_point + ", category_goods_count="
